    ...
    const sections = [
        ...
        // ─── PHILOSOPHY  (warm peach) ────────────────────────
        {
            ...
            words: [
                ...
                { text: 'My philosphy is this:', speed: M },
                { text: "if I'm better off", speed: M },
        ...
        // ─── REALIZATION  (mint / teal) ──────────────────────
        {
            ...
            defaults: { speed: M },
            words: [
                { text: 'It dawned on me', speed: S },
                { text: 'just before my', speed: M },
                { text: '16th birthday', speed: M, pauseAfter: 80 },
                ...
                { text: 'nothing would change,', speed: S, emphasis: true, pauseAfter: 400 },
                { text: 'not unless I', speed: M },
                { text: 'changed myself first.', speed: S, emphasis: true, pauseAfter: 800 },
                { text: 'I told myself that', speed: S },
                { text: '2026', speed: M, emphasis: true, pauseAfter: 100 },
                { text: 'would be my year.', speed: M, pauseAfter: 500 },
                { text: 'For the first time,', speed: S, pauseAfter: 440 },
        ...
        // ─── FINALE  (deep warm rose) ────────────────────────
        {
            ...
            words: [
                ...
                { text: 'person \u2013', speed: S, pauseAfter: 200 },
                { text: 'still incredibly', speed: M, pauseAfter: 150 },
                { text: 'introverted', speed: S, pauseAfter: 180 },
                ...
                { text: 'rather than', speed: M },
                { text: 'running from it.', speed: S, emphasis: true, pauseAfter: 1000 },
                { text: 'And that includes', speed: M },
                { text: 'you;', speed: S, emphasis: true, pauseAfter: 500 },
                { text: 'we both know what', speed: M },
                { text: 'happened two years ago,', speed: S, pauseAfter: 300 },
                { text: 'how I ruined', speed: M },
                { text: 'the moment,', speed: S, pauseAfter: 340 },
                { text: 'and I can only', speed: M },
                { text: 'imagine', speed: VS, emphasis: true, italic: true },
                { text: 'how you felt.', speed: S, italic: true, pauseAfter: 320 },
                { text: 'You reached out,', speed: M, pauseAfter: 320 },
                { text: 'I ignored it,', speed: M, pauseAfter: 320 },
                { text: 'and now,', speed: S, pauseAfter: 120 },
                { text: "it's my turn:", speed: S, pauseAfter: 1000 },
                { text: 'I love you Bella,', speed: VS, emphasis: true, grow: true, pauseAfter: 800 },
