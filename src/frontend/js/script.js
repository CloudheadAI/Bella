    ...
    const sections = [
        ...
        // ─── ADMISSION  (deeper rose) ────────────────────────
        {
            ...
            words: [
                ...
                { text: 'been', speed: F },
                { text: 'doing', speed: MF },
                { text: 'everything', speed: MF, pauseAfter: 200 },
                { text: 'wrong', speed: MF },
                { text: 'for', speed: F },
                { text: 'as', speed: MF },
                { text: 'long', speed: M },
                ...
                { text: 'I', speed: M },
                { text: 'can', speed: M },
                { text: 'remember.', speed: M, pauseAfter: 600 },
                { text: 'What', speed: S },
                { text: 'can', speed: M },
                { text: 'I', speed: M },
        ...
        // ─── PHILOSOPHY  (warm peach) ────────────────────────
        {
            ...
            words: [
                ...
                { text: 'start', speed: MF },
                { text: 'of', speed: MF },
                { text: 'it,', speed: MF, pauseAfter: 500 },
                { text: 'even', speed: M },
                { text: 'if', speed: M },
                { text: 'only', speed: M },
                { text: 'slightly,', speed: S, pauseAfter: 100 },
                { text: 'then', speed: M },
                { text: 'that', speed: S },
                { text: 'day', speed: M },
                { text: 'has', speed: M },
        ...
        // ─── REALIZATION  (mint / teal) ──────────────────────
        {
            ...
            words: [
                ...
                { text: 'time passes too quickly', speed: M, pauseAfter: 1000, emphasis: true },
                'And',
                { text: 'it became clear:', pauseAfter: 500 },
                { text: 'nothing', speed: M, emphasis: true },
                { text: 'would change,', speed: S, pauseAfter: 600 },
                { text: 'not unless I', speed: M },
                { text: 'changed myself first.', speed: S, emphasis: true, pauseAfter: 800 },
                'I', 'told', 'myself', 'that',
                { text: '2026', emphasis: true, pauseAfter: 200 },
                { text: 'would be my year.', pauseAfter: 500 },
                { text: 'For the first time,', speed: S, pauseAfter: 300 },
                { text: 'I', speed: M },
                { text: 'believed', speed: M, emphasis: true },
        ...
        // ─── FINALE  (deep warm rose) ────────────────────────
        {
            ...
            defaults: { speed: M },
            words: [
                { text: 'Ultimately,', pauseAfter: 250 },
                "I'm", 'still', 'the', 'same', 'person', '\u2013',
                { text: 'still', speed: M },
                { text: 'incredibly', speed: M, pauseAfter: 250 },
                { text: 'introverted', speed: M, pauseAfter: 180 },
                { text: '(as', speed: M },
                { text: 'always).', speed: M, pauseAfter: 340 },
                'What',
                { text: 'is', italic: true },
                { text: 'different', pauseAfter: 200 },
                'is', 'my',
                ...
                { text: 'what', speed: M },
                { text: 'I', speed: M },
                { text: 'need,', speed: S, emphasis: true, pauseAfter: 450 },
                { text: 'not', speed: M },
                { text: 'comfort.', speed: S, pauseAfter: 1000, emphasis: true },
                'And', 'that', 'includes',
                { text: 'you;', pauseAfter: 400, emphasis: true },
                { text: 'we', speed: MF },
                { text: 'both', speed: M },
                { text: 'know', speed: M },
                { text: 'what', speed: M },
                { text: 'happened', speed: M },
                { text: 'two', speed: M, emphasis: true, pauseAfter: 180 },
                { text: 'years', speed: M, emphasis: true, pauseAfter: 150 },
                { text: 'ago,', speed: S, pauseAfter: 240 },
                { text: 'how', speed: MF },
                { text: 'I', speed: MF, emphasis: true },
                { text: 'ruined', speed: M },
                { text: 'the', speed: M },
                { text: 'moment,', speed: S, pauseAfter: 340 },
                'and', 'I', 'can', 'only',
                { text: 'imagine', italic: true, pauseAfter: 240 },
                'how', 'you',
                { text: 'felt.', pauseAfter: 320 },
                { text: 'You', pauseAfter: 180 },
                'reached',
                { text: 'out,', pauseAfter: 320 },
                'and',
                { text: 'I', pauseAfter: 160 },
                'ignored',
                { text: 'it,', pauseAfter: 320 },
                { text: 'and', speed: M },
                { text: 'now', speed: MF },
                { text: "it's", speed: M },
                { text: 'my', speed: S, pauseAfter: 120 },
                { text: 'turn:', speed: S, pauseAfter: 1000 },
                { text: 'I', speed: M, pauseAfter: 180, emphasis: true },
                { text: 'love', speed: S, pauseAfter: 400, emphasis: true, grow: true },
                { text: 'you', speed: VS, pauseAfter: 240, emphasis: true, grow: true },
                { text: 'Bella,', speed: S, pauseAfter: 800, emphasis: true, grow: true },
                { text: 'I', speed: M, emphasis: true },
                { text: 'really', speed: VS, pauseAfter: 200, emphasis: true },
                { text: 'do.', speed: MF, emphasis: true, pauseAfter: 1200 },
                { text: 'No', speed: M },
                { text: 'one', speed: M },
                { text: 'else', speed: M },
                { text: 'compares,', speed: S, pauseAfter: 400, emphasis: true },
                { text: 'and', speed: M },
                { text: 'you', speed: M, pauseAfter: 240, emphasis: true, grow: true },
                { text: 'deserve', speed: M, emphasis: true },
                { text: 'to', speed: M },
                { text: 'know', speed: S },
                { text: 'that.', speed: S, pauseAfter: 4000, emphasis: true },
            ],
        },
    ];
