    ...
    const sections = [
        ...
        // ─── SELF-AWARE  (muted blue-grey) ───────────────────
        {
            ...
            words: [
                ...
                { text: 'Communication', speed: S, pauseAfter: 200 },
        ...
        // ─── ADMISSION  (deeper rose) ────────────────────────
        {
            ...
            words: [
                ...
                { text: "I've been doing", speed: MF },
                { text: 'everything wrong', speed: MF, pauseAfter: 200 },
                { text: 'for as long as', speed: MF },
                ...
                { text: 'I still have regrets,', speed: M },
                { text: 'and moving on means', speed: M },
        ...
        // ─── APOLOGY  (somber purple) ────────────────────────
        {
            ...
            words: [
                ...
                { text: "I'm too late", speed: M },
                { text: '\u2013 maybe even most \u2013', speed: MF },
                { text: 'but I say', speed: S },
                ...
                { text: 'was horrendous,', speed: S, emphasis: true, pauseAfter: 200 },
                { text: 'and words cannot describe', speed: M },
                { text: 'how sorry I am,', speed: S, emphasis: true, grow: true },
                { text: 'and forever will be.', speed: M, pauseAfter: 400 },
                { text: 'No one should ever', speed: M },
                { text: 'have to be in', speed: MF },
                { text: 'your position,', speed: M, pauseAfter: 100 },
                { text: 'and no one should', speed: MF },
                { text: 'ever act as immaturely', speed: MF },
                { text: 'as I did.', speed: M, pauseAfter: 200 },
        ...
        // ─── PHILOSOPHY  (warm peach) ────────────────────────
        {
            ...
            words: [
                ...
                { text: 'perfect:', speed: M, pauseAfter: 200 },
                { text: "I won't ever be", speed: MF },
                { text: 'the best person', speed: MF },
                { text: 'on the planet \u2013', speed: MF },
                { text: 'regardless of all the', speed: M },
                { text: 'glazing I get!', speed: M, pauseAfter: 500 },
                { text: "But I don't care,", speed: M },
                { text: 'because', speed: M, pauseAfter: 200 },
                { text: "I'm willing to learn,", speed: S, emphasis: true },
                { text: "and that's better", speed: M },
                { text: 'than most.', speed: M, pauseAfter: 400 },
                { text: 'I believe if', speed: MF },
                { text: "I'm better off", speed: MF },
                { text: 'at the end of the day', speed: MF },
        ...
        // ─── FINALE  (deep warm rose) ────────────────────────
        {
            ...
            words: [
                ...
                { text: 'not comfort.', speed: S, emphasis: true, pauseAfter: 1000 },
